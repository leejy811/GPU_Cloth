...
public:
	...
	inline glm::mat4 GetModelMatrix() const
	{
		...
		transMat = glm::translate(glm::vec3(m_Translate[0], m_Translate[1], 0.0f));
		rotXMat = glm::rotate(m_Rotate[0] * 3.14f / 180.0f, glm::vec3(1, 0, 0));
		rotYMat = glm::rotate(m_Rotate[1] * 3.14f / 180.0f, glm::vec3(0, 1, 0));
	...
	inline glm::mat4 GetViewMatrix() const
	{
		...
		transMat = glm::translate(glm::vec3(0, 0, -m_Zoom));
	...
	{
		return glm::vec3(m_Translate[0], m_Translate[1], 0.0f);
	}
