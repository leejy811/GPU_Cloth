...
static __inline__ __host__ __device__ double operator*(const double2& a, const double2& b)
{
	return a.x * b.x + a.y * b.y;
}
...
static __inline__ __host__ __device__ double2 operator*(const double b, const double2& a)
{
	return make_double2(a.x * b, a.y * b);
}
static __inline__ __host__ __device__ double2 operator/(const double b, const double2& a)
...
static __inline__ __host__ __device__ void operator+=(double2& a, const double2& b)
{
	a.x += b.x;
	a.y += b.y;
}
...
static __inline__ __host__ __device__ void operator+=(double2& a, const double b)
{
	a.x += b;
	a.y += b;
}
...
static __inline__ __host__ __device__ double LengthSquared(const double2& a)
{
	return a * a;
}
static __inline__ __host__ __device__ double Length(const double2& a)
{
	return sqrt(a * a);
}
...
static __inline__ __host__ __device__ double Cross(const double2& a, const double2& b)
{
	return a.x * b.y - a.y * b.x;
}
//-------------------------------------------------------------------------------------------------------------
static __inline__ __host__ __device__ float2 operator+(const float2& a, const float2& b)
{
...
static __inline__ __host__ __device__ float operator*(const float2& a, const float2& b)
{
	return a.x * b.x + a.y * b.y;
}
static __inline__ __host__ __device__ float2 operator+(const float2& a, const float b)
{
...
static __inline__ __host__ __device__ float2 operator*(const float b, const float2& a)
{
	return make_float2(a.x * b, a.y * b);
}
static __inline__ __host__ __device__ float2 operator/(const float b, const float2& a)
...
static __inline__ __host__ __device__ void operator+=(float2& a, const float2& b)
{
	a.x += b.x;
	a.y += b.y;
}
...
static __inline__ __host__ __device__ void operator+=(float2& a, const float b)
{
	a.x += b;
	a.y += b;
}
...
static __inline__ __host__ __device__ float LengthSquared(const float2& a)
{
	return a * a;
}
static __inline__ __host__ __device__ float Length(const float2& a)
{
	return sqrtf(a * a);
}
static __inline__ __host__ __device__ float Dot(const float2& a, const float2& b)
{
	return a.x * b.x + a.y * b.y;
}
static __inline__ __host__ __device__ float Cross(const float2& a, const float2& b)
{
	return a.x * b.y - a.y * b.x;
}
//-------------------------------------------------------------------------------------------------------------
